...
namespace Client1GUI
{
    ...
    public partial class MainWindow : Window
    {
        ...
        string author;
        string authorType;
        string localUrl { get; set; } = "http://localhost:8080/CommService";
        ...
        /// <summary>
        /// This is the function which is called for demo purpose
        /// </summary>
        void automaticDemo()
        {
            ...
            filemsg.body = string.Join(";",Util.GetFilesFromTestRequest(req));
        ...
        /// <summary>
        /// this function will get activated after after test execution got completed
        /// </summary>
        /// <param name="msg"></param>
